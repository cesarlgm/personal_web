...
<div class="media stream-item view-compact">
    <div class="media-body">
        <div class="section-subheading article-title mb-0 mt-0" id="amenities_es">Work Hours and Amenity Trade-Offs</div>
        ...
        <div class="btn-links">
           ...
           <a class="btn btn-outline-primary btn-page-header btn-sm" href="https://www.openicpsr.org/openicpsr/project/221382/version/V1/view" target="_blank">Código de replicación</a>
            <p id="amenities_abstract_es" class="hidden" style="display: none; font-size:0.8em; text-align: justify"><br>
...
<div class="media-body">
    <div class="section-subheading article-title mb-0 mt-0" id="idn-secondary_es">Expanding Access in a Semi-Private Education Market: Evidence from a Large High School Expansion</div>
        <div class="article-style">
            ...
            <a class="btn btn-outline-primary btn-page-header btn-sm" href="/es/blogs/secondary-expansion/secondary-expansion" target="_blank">Resumen no técnico</a>
...
<div class="media stream-item view-showcase">
    <div class="media-body">
        <div class="section-subheading article-title mb-0 mt-0" id="smk_es">Linking Vocational Schools to Industry: Effects on Teachers in Indonesia</div>
        <div class="article-style">
        ...
        <div class="btn-links">
            ...
            <a class="btn btn-outline-primary btn-page-header btn-sm" href="/es/blogs/teacher-training/teacher-training" target="_blank">Resumen ejecutivo</a>
...
<div class="universal-wrapper">
   <div class="media stream-item view-compact">
        <div class="media-body">
            <div class="section-subheading article-title mb-0 mt-0" id="skill-use_es">Skill Use in Jobs: The Role of Education and Technology</div>
            <div class="article-style">
    ...
    <div class="media stream-item view-showcase">
        <div class="media-body">
            <div class="section-subheading article-title mb-0 mt-0" id="gender-crime_es">Gender and violent conflict</div>
                <div class="article-style">
