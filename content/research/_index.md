...
<div class="media stream-item view-compact">
    <div class="media-body">
        ...
        <div class="btn-links">
               ...
               <a class="btn btn-outline-primary btn-page-header btn-sm" href="/blogs/academia/us_academia" target="_blank">Non-technical summary</a>
               ...
               <a class="btn btn-outline-primary btn-page-header btn-sm" href="https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/64PORL" target="_blank">Replication Package</a>               
                <p id="akm_abstract" class="hidden" style="display: none; font-size:0.8em; text-align: justify"><br><strong>Abstract: </strong>Do elite universities overpay their faculty? No. Elite institutions offer high salaries because they compete with other elite institutions for the most valued faculty. In contrast to the broader labor market, faculty are equally likely to move up and down the prestige ladder, and they increase their salary either way. We speculate that these differences reflect the visible nature of faculty productivity and the sporadic nature of academic job openings.</p>
        </div>
    </div>
    <div class="ml-3">
    ...
    <div class="media-body">
        ...
        <div class="btn-links">
           ...
           <a class="btn btn-outline-primary btn-page-header btn-sm" href="https://www.openicpsr.org/openicpsr/project/221382/version/V1/view" target="_blank">Replication Package</a>
            <p id="amenities_abstract" class="hidden" style="display: none; font-size:0.8em; text-align: justify"><br>
        ...
        <!--<div class="btn-links">
           <div class="article-style"><strong>Media coverage:</strong> <a class="btn btn-outline-primary btn-page-header btn-sm" target="_blank" onclick="showHideText('amenities_abstract')">Faculti.net</a></div>
        </div>-->
    </div>
    <div class="ml-3">
...
<div class="media-body">
    <div class="section-subheading article-title mb-0 mt-0" id="idn-secondary">Expanding Access in a Semi-Private Education Market: Evidence from a Large High School Expansion</div>
        <div class="article-style">
            ...
            <a class="btn btn-outline-primary btn-page-header btn-sm" href="/blogs/secondary-expansion/secondary-expansion" target="_blank">Non-technical summary</a>
...
<div class="media stream-item view-showcase">
    <div class="media-body">
        ...
        <div class="article-style">
        We evaluate a large training program for vocational high school teachers in Indonesia <font  color="#dd2c00">| Revised draft!  </font> <br> <i>Submitted</i> </div>
        <div class="stream-meta article-metadata">
            <div class="article-metadata">
                <div>
                    <span class="author">César Garro-Marín,</span>
        ...
        <div class="btn-links">
            ...
            <a class="btn btn-outline-primary btn-page-header btn-sm" href="/blogs/teacher-training/teacher-training" target="_blank">Non-technical summary</a>
...
<div class="media stream-item view-compact">
    <div class="media-body">
        ...
        <div class="article-style">I show that the place women grow up in shapes their participation in the labor market as adults <font  color="#dd2c00">| Big rework in progress </font> </div>
        <div class="stream-meta article-metadata">
            <div class="article-metadata">
...
<script>
if (window.location.hash === '#public-private-expansion') {
  window.location.replace('https://cesarlgm.github.io/documents/papers/idn_secondary_expansion.pdf');
}
</script>
