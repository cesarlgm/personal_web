...
El programa estudiado en [nuestro artículo](https://cesarlgm.github.io/documents/papers/garroHilmy_smk.pdf) tenía un diseño atractivo. En lugar de depender del propio gobierno para recapacitar a los docentes, el gobierno contrató empresas del sector privado---las mismas que contratan a los egresados de las escuelas vocacionales---para impartir una formación intensiva y específica por campo a los docentes. Con una duración promedio de seis a ocho semanas, los cursos eran sustancialmente más largos que el programa típico de desarrollo profesional docente a nivel mundial, que dura apenas dos semanas y media (Popova et al., 2022).

La intuición era convincente: ¿quién mejor para enseñar soldadura, enfermería o electrónica que las empresas que utilizan esas habilidades cada día? Los docentes aprenderían técnicas actualizadas y relevantes para la industria y las trasladarían al aula. A gran escala, esto podría hacer que la educación vocacional fuera genuinamente útil para el mercado laboral.

Evaluamos esta idea mediante una evaluación aleatorizada: algunos docentes fueron seleccionados para participar en el programa y otros no---similar a un ensayo clínico para un nuevo medicamento. Este diseño permite una comparación limpia entre lo ocurrido en las *escuelas del programa* y en las *escuelas de control*.

## Los resultados fueron desalentadores

El programa no cumplió su promesa:

- **Sin aumento en la formación total.** Los docentes en las escuelas del programa tenían casi el
...
El programa cambió el *tipo* de formación que recibieron los docentes, no la cantidad de lo que aprendieron o enseñaron.
